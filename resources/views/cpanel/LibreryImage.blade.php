                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                               <td>{{ $loop->iteration }}</td>
                                                <td> {{ $LibreryImag->userName()->name}} </td>
                                              


                                                <td>
                                                 <img src="{{ asset('uploads/' .$LibreryImag->image) }}" style="height: 155px;">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#centralModalSm{{ $LibreryImag->id }}">
ازالة                                                             </button> 
...
<!-- Central Modal Small -->
<div class="modal fade" id="centralModalSm{{ $LibreryImag->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
...
<!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
 -->
              {!!  Form::open(['url' => ['admin/removelibraryimage',$LibreryImag->id] ,'method' => 'post','files' => true]) !!}
