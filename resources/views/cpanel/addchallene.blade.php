                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <div class="portlet box blue">
                                            <div class="portlet-title" style="background: #17C4BB;">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>التحديات  </div>
                                                <div class="tools">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
 {!!  Form::open(['url' => ['admin/storechalleng'] ,'method' => 'POST','files' => true]) !!}                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">   تاريخ انتهاء  </label>
                                                                            <input type="date" id="lname" name="enddate"  class="form-control"  required="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <textarea name="content_ar" rows="19" ></textarea>
                                                                </div>
                                                            </div>
                                                            <!--/span-->
                                                      ...
                                                      <div class="row">
                                                           ...
                                                           <textarea name="content_en"  rows="19"  cols="30"></textarea>
                                                                </div>
                                                            </div>
                                                            <!--/span-->
