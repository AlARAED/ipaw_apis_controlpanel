                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-toolbar">
                            <div class="btn-group pull-right">
                                <a href="{{ url('admin/addblogs') }}" type="button" class="btn btn-fit-height grey-salt "  style="background: #17C4BB;" > 
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                               <td>{{ $loop->iteration }}</td>
                                                ...
                                                <td>
                                                 <img src="{{ asset('uploads/' .$Blog->image) }}" style="height: 155px;">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#centralModalSm{{ $Blog->id }}">
ازالة                                                             </button> 



                                                           
                                                            <a type="button" class="btn btn-primary" href="{{url('admin/ediblogs/'.$Blog->id)}}">
تعديل
                                                             </a> 
...
<!-- Central Modal Small -->
<div class="modal fade" id="centralModalSm{{ $Blog->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
...
<!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
 -->
              {!!  Form::open(['url' => ['admin/removeblogs',$Blog->id] ,'method' => 'POST','files' => true]) !!}
