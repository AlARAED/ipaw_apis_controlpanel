...
<div class="page-content">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"  >   حيوانات مفقودة </span>
                                    </div>
  ...
  @foreach($LostAnimal  as $LostAnima)


 
                                            <tr class="odd gradeX">
                                               <td>{{ $loop->iteration }}</td>
                                                <td> {{ $LostAnima->userName()->name}}</td>

                                                

                                                <td>
                                                 <img src="{{ asset('uploads/' .$LostAnima->image) }}" style="height: 155px;">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#centralModalSm{{ $LostAnima->id }}">
ازالة                                                            
 </button> 
...
<!-- Central Modal Small -->
<div class="modal fade" id="centralModalSm{{ $LostAnima->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
...
<!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
 -->
              {!!  Form::open(['url' => ['admin/removelostanimal',$LostAnima->id] ,'method' => 'POST','files' => true]) !!}
