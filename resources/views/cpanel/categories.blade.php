...
<a href="{{url('admin/allcare/'.$Categ->id)}}"  class="btn btn-primary" >
                                                        عناصر العناية
...
<!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
 -->
              {!!  Form::open(['url' => ['admin/removecategory',$Categ->id] ,'method' => 'POST','files' => true]) !!}
  ...
  <div class="modal-dialog modal-sm " role="document">
    ...
    <div class="modal-content" >
      ...
      <div class="modal-body">
<div class="container">
              {!!  Form::open(['url' => ['admin/storecategory'] ,'method' => 'POST','files' => true]) !!}
    <div class="row">
      <div class="col-25">
