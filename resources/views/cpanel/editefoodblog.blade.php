                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <div class="portlet box blue">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
 {!!  Form::open(['url' => ['admin/ediFoodBlog/'.$FoodBlog->id] ,'method' => 'POST','files' => true]) !!}                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">العنوان  باللغة العربية </label>
                                                                     <input type="text" class="form-control" name="name_ar" value="{{$FoodBlog->name_ar}}" required="" />
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">  العنوان باللغة الانجليزية </label>
                                                                      <input type="text" class="form-control" name="name_en" value="{{$FoodBlog->name_en}}" required="" />
...
<div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">الوصف القصير  باللغة العربية </label>
                                                                     <input type="text" class="form-control" name="short_desc_ar" value="{{$FoodBlog->short_desc_ar}}" required="" />
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                 ...
                                                                 <input type="text" class="form-control" name="short_desc_en" value="{{$FoodBlog->short_desc_en}}" required="" />
...
<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                        <img src="{{ asset('uploads/' .$FoodBlog->image) }}" alt=""  style="height: 155px;" /> </div>
