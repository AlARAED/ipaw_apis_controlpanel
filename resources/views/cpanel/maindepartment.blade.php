                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"  >  الأقسام للمدونات</span>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                               <td>{{ $loop->iteration }}</td>
                                                <td> {{ $MainDepartmen->name_ar}} </td>
                                                  <td> {{ $MainDepartmen->name_en}} </td>

                                                <td>
                                                 <img src="{{ asset('uploads/' .$MainDepartmen->image) }}" style="height: 155px;">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#centralModalSm{{ $MainDepartmen->id }}">
ازالة                                                             </button> &#160;


<!-- <a href="{{url('admin/allcare/'.$MainDepartmen->id)}}"  class="btn btn-primary" >
                                                        عناصر العناية
...
<!-- Central Modal Small -->
<div class="modal fade" id="centralModalSm{{ $MainDepartmen->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title w-100" id="myModalLabel"> الازالة </h4>
...
<!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
 -->
              {!!  Form::open(['url' => ['admin/removemaindepartment',$MainDepartmen->id] ,'method' => 'POST','files' => true]) !!}
...
<div class="modal fade" id="centralModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-sm " role="document">
    ...
    <div class="modal-content" >
      ...
      <div class="modal-body">
<div class="container">
              {!!  Form::open(['url' => ['admin/storemaindepartment'] ,'method' => 'POST','files' => true]) !!}
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname"> اسم  باللغة  الاانجليزية</label>
      </div>
      <div class="col-75">
